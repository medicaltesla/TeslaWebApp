        ...
        <div className="bg-primary-500">
            <footer className="container mx-auto mt-6 w-full">
                ...
                <div className="md:my-2 lg:grid lg:grid-col-4 md:grid md:grid-cols-4 sm:grid sm:grid-cols-2 md:mx-2">
                    ...
                    <div className='md:col-span-1 sm:col-span-1 px-4 py-4 text-center'>
                    ...
                    <div className='md:col-span-1 sm:col-span-1 px-4 py-4 text-white text-start'>
                ...
                <div className="px-4 md:my-2 sm:flex sm:items-center sm:justify-between justify-items-center items-center">
                    <span className="text-sm px-2 text-white sm:text-center ">Copyright © 2024 <a href="/" className="hover:underline">Tesla Hi-Tech MRI Imaging Diagnostic Center</a> All Rights Reserved.
                        <Link href='https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=teslahitechimaging@gmail.com' rel='noopener noreferrer' className='text-white ml-1 ' target='_blank'>📧 teslahitechimaging@gmail.com</Link>
