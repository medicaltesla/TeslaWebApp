...
const WelcomeText = () => {
  return (
    <div className="container mx-auto">
      <div className="md:my-2 lg:grid lg:grid-cols-1 md:grid md:grid-cols-1 sm:grid sm:grid-cols-1 justify-items-center items-center mt-4">
          <div className="max-w-full rounded-lg overflow-hidden p-4">
            <h3 className="title-font sm:text-3xl text-2xl font-bold mb-6 mt-4 text-center">Welcome to Tesla Hi-Tech Imaging & Diagnostic Centre</h3>
            ...
            <p className="text-gray-900 font-semibold mb-4">
              We are available 24/7 to serve you, ensuring round-the-clock access to the best diagnostic services.
            </p>
            <p className="text-gray-900 text-base mb-4">
              <span>
                At Tesla Hi-Tech, our commitment extends beyond technology; our experienced team of radiologists and medical professionals strive to provide compassionate service and support throughout your healthcare journey.
                <b> Treatment begins at Tesla Hi-Tech Imaging and Diagnostic Center,</b> where cutting-edge technology meets expert care to ensure the best possible outcomes for your health.
              </span>
            </p>
          </div>
      </div>
